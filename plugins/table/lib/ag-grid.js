...
/***/ function(module, exports) {
	...
	var Events = (function () {
		...
		Events.EVENT_ROW_MOUSEOVER = 'rowMouseover';
		Events.EVENT_ROW_MOUSEOUT = 'rowMouseout';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RenderedRow = (function () {
	    ...
	    RenderedRow.prototype.createRowContainer = function () {
			...
			vRow.addEventListener("mouseover", this.onRowMouseover.bind(this));
			vRow.addEventListener("mouseout", this.onRowMouseout.bind(this));
		...
		RenderedRow.prototype.onRowMouseout = function (event) {
	        var agEvent = this.createEvent(event, this);
	        this.mainEventService.dispatchEvent(events_1.Events.EVENT_ROW_MOUSEOUT, agEvent);
	    };
		RenderedRow.prototype.onRowMouseover = function (event) {
	        var agEvent = this.createEvent(event, this);
	        this.mainEventService.dispatchEvent(events_1.Events.EVENT_ROW_MOUSEOVER, agEvent);
	    };
